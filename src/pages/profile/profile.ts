...
export class ProfilePage {
    ...
    ShareApp()
    {
        ...
        this.socialSharing.share("Hey there join me (" + this.karigar_detail.full_name + "-" + this.karigar_detail.mobile_no + ") on Aimy Luminaries, a Electrician & Dealer app. Enter my code *" + this.karigar_detail.referral_code + "* to earn points back in your wallet!", "Reffral", image, app_url)
        .then(resp => {
            console.log(resp);
